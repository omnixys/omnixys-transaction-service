...
import com.omnixys.transaction.models.dto.BalanceDTO;
...
public class TransactionWriteService {
  ...
  public Transaction pay(final Transaction transaction, final UUID paymentId) {
    log.debug("pay: transaction={}, paymentId={}", transaction, paymentId);
    ...
    var savedTransaction = transactionRepository.save(transaction);
    log.debug("pay: savedTransaction={}", savedTransaction);
    return savedTransaction;
  }
